          ...
          <div className="col-span-1 flex justify-start pl-2 px-px">
            <div className="relative">
              ...
              height: '360px'
                ...
                <div className="absolute top-0 left-0 w-full bg-capiva-orange rounded-full transition-all duration-100 ease-linear" style={{
                height: `${progress}%`
              }} />
              </div>
              ...
              height: '360px'
                ...
                {banners.map((banner, index) => <div key={banner.id} className="w-3 h-3 rounded-sm border-2 border-capiva-orange bg-capiva-orange" style={{
          ...
          <div className="col-span-6 space-y-8 pl-2 pr-4">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                {banners[currentIndex].id === 1 && <h3 className="text-6xl font-bold text-gray-900 leading-tight">
                    {banners[currentIndex].description}
                  </h3>}
              </div>
              
              {banners[currentIndex].id !== 1 && <p className="text-xl text-gray-600 max-w-2xl leading-relaxed">
                  {banners[currentIndex].description}
                </p>}
